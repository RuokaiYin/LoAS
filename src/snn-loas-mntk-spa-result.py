...
if __name__ == '__main__':
    ...
    results = test_real_data(f'../matrices_dict/{args.arch}_{args.spar_lvl}_final_matrices_dict_loas_{args.loas}.pth')
    torch.save(results, f'./loas-mntk_{args.loas}_{args.arch}_{args.spar_lvl}_dict.pth')
