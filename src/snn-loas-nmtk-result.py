...
if __name__ == '__main__':
    ...
    results = test_real_data(f'./matrices_dict/{args.arch}_final_matrices_dict_loas_{args.loas}.pth')
    torch.save(results, f'./loas-nmtk_{args.loas}_{args.arch}_dict.pth')
