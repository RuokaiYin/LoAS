...
def ann_sim_layer(inp_mat, w_mat, tiling_dataflow, tile_dict):
...
def test_real_data(path):
    ...
    for k,v in matrices_dict.items():
        ...
        print(inp_mat.shape)
        w_mat = v['w']
        result_dict[k] = ann_sim_layer(inp_mat, w_mat, tiling_dataflow, tile_dict)
    
    return result_dict

if __name__ == '__main__':
    parser = argparse.ArgumentParser("ANN-Sparten-simulation")
